...
class TestUAI < Minitest::Test
  ...
  def test_show_avaliable_times
    expected = <<~AVALIABLE
      +----------+---------------+-------------+--------------+--------------+-------------+
      |          | SEGUNDA-FEIRA | TERÇA-FEIRA | QUARTA-FEIRA | QUINTA-FEIRA | SEXTA-FEIRA |
      +----------+---------------+-------------+--------------+--------------+-------------+
      | 07:00:00 | sem aula      | sem aula    |              | sem aula     | sem aula    |
      | 07:50:00 | sem aula      | sem aula    |              | sem aula     | sem aula    |
      | 08:40:00 | sem aula      | sem aula    | sem aula     |              |             |
      | 09:50:00 | sem aula      |             | sem aula     |              |             |
      | 10:40:00 | sem aula      |             | sem aula     |              |             |
      | 11:30:00 | sem aula      | sem aula    | sem aula     | sem aula     | sem aula    |
      | 13:00:00 |               |             |              |              |             |
      | 13:50:00 |               |             |              |              |             |
      | 14:40:00 |               |             |              |              | sem aula    |
      | 15:50:00 |               |             |              |              | sem aula    |
      | 16:40:00 |               | sem aula    |              |              | sem aula    |
      | 17:30:00 | sem aula      | sem aula    | sem aula     | sem aula     | sem aula    |
      | 18:20:00 | sem aula      | sem aula    | sem aula     | sem aula     | sem aula    |
      | 19:10:00 | sem aula      | sem aula    | sem aula     | sem aula     | sem aula    |
      | 20:00:00 | sem aula      | sem aula    | sem aula     | sem aula     | sem aula    |
      | 20:50:00 | sem aula      | sem aula    | sem aula     | sem aula     | sem aula    |
      | 21:40:00 | sem aula      | sem aula    | sem aula     | sem aula     | sem aula    |
      +----------+---------------+-------------+--------------+--------------+-------------+
    AVALIABLE

    avaliable_side_times = @uai.show_avaliable_times "CRISHANE AZEVEDO FREIRE",
                          "DAMIRES YLUSKA DE SOUZA FERNANDES",
                          "EDEMBERG ROCHA DA SILVA",
                          "LUIZ CARLOS RODRIGUES CHAVES"

    assert_equal expected, avaliable_side_times
  end
